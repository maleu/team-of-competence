<div id='kunde_neu'>
	<form>
		Vorname: <input name="P_vorname" type="text" class='crmNeukundeForm' id="crm_input_Vorname" maxlength="20" />
		Nachname: <input name="P_nachname" type="text" class='crmNeukundeForm' id="crm_input_Nachname" maxlength="20" />
		Firma: <input name="P_firma" type="text" class='crmNeukundeForm' id="crm_input_Firma" maxlength="20" />
		Strasse: <input name="P_Strasse" type="text" class='crmNeukundeForm' id="crm_input_Strasse" maxlength="20" />
		Postleitzahl: <input name="P_PLZ" type="text" class='crmNeukundeForm' id="crm_input_PLZ" maxlength="20" />
